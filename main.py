...
def perform_compression(image, R_block_size, calculate_flg):
  ...
  comp_pic = "C:\\Users\\Adam\\Documents\\GitHub\\TC-SEFR\\pictures\\" + imageA.name + "compressed.pgm"
  print comp_pic
  imageA.export(comp_pic)

def authenticate(image, R_block_size):
...
with_watermark = img('./pictures/scarlettcompressed.pgm')
